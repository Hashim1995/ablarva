    ...
    <div className="p-20 min-h-screen overflow-y-auto remove-scrollbar">
      <div className="justify-center pr-3 h-96">
        <p className="pb-6 text-md">
          We, in AI-zade, (" Company ", "we", "us", "our") are committed to
        ...
        <p className="pb-6 text-md">
          ...
          Website or otherwise when you contact us. The personal information
          that we collect depends on the context of your interactions with us
          and the Website, the choices you make and the products and features
        ...
        <p className="pb-6 text-md">The information we collect includes:</p>
        ...
        <ul className="pl-6 text-md list-disc">
          ...
          <li className="mb-6">
            <span className="font-medium">
              ...
              purposes, to comply with legal and regulatory info-tip or in
        ...
        <ul className="pl-6 text-md list-disc">
          ...
          <li className="mb-6">
            <span className="font-medium">Vital Interests: </span>We may
        ...
        <p className="pb-6 text-md">
          ...
          accounting or other legal info-tip). No purpose in this notice will
