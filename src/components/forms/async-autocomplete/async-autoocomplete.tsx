...
interface IAppHandledAsyncAutocomplete {
  name: string;
  control: any;
  rules?: Omit<
...
function AppHandledAsyncAutocomplete({
  name,
  control,
  rules,
  isInvalid,
  ...
  size,
  label
}: IAppHandledAsyncAutocomplete): ReactElement {
...
export default AppHandledAsyncAutocomplete;
